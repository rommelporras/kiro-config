...
- For each count in the Features section (e.g., "N steering docs", "N skills", "N hooks", "N agents"), verify the number against the actual filesystem. Current baseline as of v0.5.0: 11 steering docs, 18 skills, 11 hooks, 10 agents.
