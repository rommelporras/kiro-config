...
6. **Spec review loop** — dispatch a spec-reviewer delegate with the spec and requirements (not your session history); fix issues and re-dispatch until approved (max 3 iterations, then surface to human)
...
1. Dispatch a spec-reviewer delegate with the spec document path and requirements
