...
| Delegate completed | Git diff shows changes | Delegate reports "success" |
...
- Trusting delegate success reports
...
**Delegate work:**
```
✅ Delegate reports success → Check git diff → Verify changes → Report actual state
❌ Trust delegate report
```

## Why This Matters

From past failure patterns:
